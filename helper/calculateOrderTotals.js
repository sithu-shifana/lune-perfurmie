...
const prepareOrderForSave = (order, coupon = null) => {
  ...
  order.items.forEach(item => {
    calculateItemPricing(item); // Use the calculateItemPricing function
  ...
  // Calculate totalCouponDiscount based on active items only
  ...
  // Calculate final total: subtotal minus coupon discount for active items
